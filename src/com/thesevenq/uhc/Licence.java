...
public class Licence {
    ...
    public Licence(String licenseKey, String validationServer, Plugin plugin){
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public Licence setSecurityKey(String securityKey){
        this.securityKey = securityKey;
        return this;
    }

    public Licence setConsoleLog(LogType logType){
        this.logType = logType;
        return this;
    }

    public Licence debug(){
        debug = true;
        return this;
    }

    public boolean register(){
        log(0, ChatColor.YELLOW + "Connecting to License-Server...");
        ValidationType vt = isValid();
        if(vt == ValidationType.VALID){
            log(1, ChatColor.GREEN + "License valid!");
            return true;
        }else{
            log(1, ChatColor.RED + "License is NOT valid!");
            log(1, ChatColor.RED + "Disabling plugin!");
