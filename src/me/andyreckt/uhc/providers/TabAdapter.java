...
import io.github.thatkawaiisam.ziggurat.utils.ping.PingValue;
...
public class TabAdapter implements ZigguratAdapter {
    ...
    public Set<BufferedTabObject> getSlots(Player player) {
        ...
        tab.add(new BufferedTabObject().text("&eDeaths&7: &9" + data.getDeaths()).column(TabColumn.MIDDLE).slot(11));
