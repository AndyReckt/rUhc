...
import me.andyreckt.uhc.utilties.items.Items;
...
public class InventoryManager extends Manager {
	...
	public InventoryManager(UHC plugin) {
		...
		scenarioInfo = Bukkit.createInventory(null, 45, Color.translate("&9Current Scenarios"));
		uhcSettings = Bukkit.createInventory(null, 9, Color.translate("&9UHC Settings"));
		uhcPlayerSettings = Bukkit.createInventory(null, 45, Color.translate("&9UHC Settings"));
		options = Bukkit.createInventory(null, 27, Color.translate("&9Options Inventory"));
		scatter = Bukkit.createInventory(null, 9, Color.translate("&9Scatter Inventory"));
		uhcPractice = Bukkit.createInventory(null, 9, Color.translate("&9Practice"));
		toggleScenarios = Bukkit.createInventory(null, 45, Color.translate("&9Toggle Scenarios"));
		maxPlayers = Bukkit.createInventory(null, 45, Color.translate("&9Max Players"));
		rates = Bukkit.createInventory(null, 36, Color.translate("&9Rates Inventory"));
		team = Bukkit.createInventory(null, 27, Color.translate("&9Parties"));
