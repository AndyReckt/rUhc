...
public class StringUtils {
	...
	private static long convert(int value, char unit) {
		...
		case 'M': {
			return value * TimeUnit.MINUTES.toMillis(30L);
		}
	...
	public static void changeProperties(int slots) {
		Path resolve = Paths.get(UHC.getInstance().getDataFolder().getParentFile().getAbsolutePath(), new String[0]).getParent().resolve("server.properties");
